...
const QuestionSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["submitted", "approved", "rejected", "quoted", "awaiting_payment", "paid", "awaiting_response", "answered", "in_thread", "closed", "cancelled"],
      default: "submitted",
      index: true
    },
    thread: {
    ...
    timeline: [{ at: Date, status: String, by: { type: mongoose.Schema.Types.ObjectId, ref: "Users" }, note: String }]
  },
  { timestamps: true }
);
